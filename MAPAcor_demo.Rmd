...
Pearson's correlation has slower than root-n convergence when estimating trying to estimate prediction accuracy for machine learning prediction models.
...
- _to_: columns that contain '_to_' represent functional brain measures, or variables that give a measure of brain activity within specific regions of the brain.  
